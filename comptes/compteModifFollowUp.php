...
<head>
    ...
    <title>kmermarketshopping - Comptes Modifications</title> <!-- Element spécifiwue -->
	...
	<script type="text/javascript" src="../js/inscription.js"></script>
		...
		<body>
			<header>
				<a href="../index.php">
					<img src="../img/trueLogoKmerMarket.png" alt="lelogodekmermarket"/>
				</a>
			...
			<div id="super_inscrit" style='background-color:white;'>	
				...
				<fieldset >
					<h1 >
						Bravo, votre compte a été modifié ! <br/>
						Rendez-vous, dans votre boîte email, <br/>
						pour voir vos informations ! :)
